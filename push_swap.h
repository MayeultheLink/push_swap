...
/*   Updated: 2021/07/29 15:52:35 by mde-la-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_stack	sorting_b2a(t_stack stacks, int min);
...
int		find_med(t_list *lst);
int		lst_indice(t_list *lst, int indice);
t_stack	test(t_stack stacks);
